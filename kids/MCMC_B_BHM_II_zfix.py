...
# save the chain
np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/latent{}.npy'.format(0), sps_prior.bijector(latent_samples_).numpy().astype(np.float32) )
np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/z{}.npy'.format(0), sps_prior.bijector(latent_samples_).numpy()[...,-1].astype(np.float32) )
np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/hyper{}.npy'.format(0), hyper_samples_[-1,...].numpy().astype(np.float32))
np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/nz{}.npy'.format(0), nz_samples_[-1,...].numpy().astype(np.float32))
...
# save the chain
np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/latent{}.npy'.format(1), sps_prior.bijector(latent_samples_).numpy().astype(np.float32) )
np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/z{}.npy'.format(1), sps_prior.bijector(latent_samples_).numpy()[...,-1].astype(np.float32) )
np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/hyper{}.npy'.format(1), hyper_samples_[-1,...].numpy().astype(np.float32))
np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/nz{}.npy'.format(1), nz_samples_[-1,...].numpy().astype(np.float32))
...
for step in range(n_steps):
    ...
    # save the chain
    np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/latent{}.npy'.format(step+2), sps_prior.bijector(latent_samples_).numpy().astype(np.float32) )
    np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/z{}.npy'.format(step+2), sps_prior.bijector(latent_samples_).numpy()[...,-1].astype(np.float32) )
    np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/hyper{}.npy'.format(step+2), hyper_samples_[-1,...].numpy().astype(np.float32))
    np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_zfix/nz{}.npy'.format(step+2), nz_samples_[-1,...].numpy().astype(np.float32))
