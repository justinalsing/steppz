...
if burnin is True:
    ...
    # save the chain
    np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_with_selection_zfix/latent{}.npy'.format(0), sps_prior.bijector(latent_samples_).numpy().astype(np.float32) )
    np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_with_selection_zfix/z{}.npy'.format(0), sps_prior.bijector(latent_samples_).numpy()[...,-1].astype(np.float32) )
...
for step in range(n_steps):
    ...
    # save the chain
    np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_with_selection_zfix/latent{}.npy'.format(step+1), sps_prior.bijector(latent_samples_).numpy().astype(np.float32) )
    np.save('/cfs/home/alju5794/steppz/kids/chains/B_BHM_II_with_selection_zfix/z{}.npy'.format(step+1), sps_prior.bijector(latent_samples_).numpy()[...,-1].astype(np.float32) )
