...
@tf.function
def log_likelihood_studentst2(fluxes, flux_variances, predicted_fluxes, predicted_flux_variances):
...
@tf.function
def log_likelihood_normal(fluxes, flux_variances, predicted_fluxes, predicted_flux_variances):
